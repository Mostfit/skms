class Tweet #address your network. everyone hears it.
  ...
  is_indexed :texts => [:content], :values => [[:content, 0, 'content', :string]], :terms => [[:content, 'A', 'tweet']] #uses dm-xapian plugin for 'full text searching'. Read more at: 'http://github.com/frabcus/acts_as_xapian/tree/master'
